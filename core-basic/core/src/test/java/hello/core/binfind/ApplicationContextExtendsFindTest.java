...
public class ApplicationContextExtendsFindTest {
    ...
    void findAllBeanByParentType() {
        ...
        assertThat(beansOfType.get("rateDiscountPolicy")).isInstanceOf(RateDiscountPolicy.class);
        assertThat(beansOfType.get("fixDiscountPolicy")).isInstanceOf(FixDiscountPolicy.class);
    ...
    @Test
    @DisplayName("부모 타입으로 모두 조회하기 - by using Object")
